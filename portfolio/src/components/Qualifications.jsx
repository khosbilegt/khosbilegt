...
import { qualificationsInfo } from '../constants';

function Qualifications() {
  return (
     <Element name="qualifications" className={`${styles.paddingX}`}>
     <h1 className={`text-gray-300 text-[20px] font-light mb-5`}>
          Qualifications
     </h1>

     <ol class={`relative border-l border-gray-200 dark:border-gray-700`}>
          {qualificationsInfo.map((val, index) => (
               <li className="mb-10 ml-6">
                    ...
                    <time class="block mb-2 text-sm font-normal leading-none text-gray-500">{val.issuer}, {val.date}</time>
